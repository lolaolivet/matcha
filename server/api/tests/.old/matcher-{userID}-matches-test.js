...
describe('tests for /users/{userid}/matcher/matches', function () {
  describe('tests for get', function () {
    ...
    it('should respond 401 for "Unauthorized" (no auth header)', function () {
      var response = request('get', `${baseurl}/${user.userid}/matcher/matches`, {
        'headers': {
          "Content-Type": "application/json",
          "Accept": "application/json"
        },
    ...
    it('should respond 404 for "Not Found"', function () {
      var response = request('get', `${baseurl}/0/matcher/matches`, {
        'headers': {
          "Content-Type": "application/json",
          "Accept": "application/json",
          "Authorization": authHeader(user.jwt)
