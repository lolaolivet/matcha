...
describe('tests for /users/{userid}/matcher/places', function () {
  describe('tests for get', function () {
    ...
    it('should respond 401 for "Unauthorized" (no auth header)', function () {
      var response = request('get', `${baseurl}/${user.userid}/matcher/places`, {
        'headers': {
    ...
    it('should respond 404 for "User not found"', function () {
      var response = request('get', baseurl + '/0/matcher/places', {
        'headers': {
          "Content-Type": "application/json",
          "Accept": "application/json",
          "Authorization": authHeader(user.jwt)
